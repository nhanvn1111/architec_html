...
$(document).ready(function() {
	...
	/* FADE IMAGES */
	$('.button, .facebook, .twitter, .mapimg, .workimg, .btnseework, .mapimg, .backthumbs, .moreinfo, .css_next, .css_prev, .css_prev_nav, .css_next_nav, .prev, .next, .seeproject, .lightoff').append('<span class="hover"></span>').each(function () {
